...
public class ToMongo_fang {
    ...
    */
    ...
    public static String path="E:\\房地产可视化\\toMongo\\resold\\fang\\";
    public static void main(String[] args) throws IOException {

        ToMongoDB("BasicData_Resold_100","fang");
    ...
    public static void ToMongoDB(String collName,String source){
        ...
        try {
            ...
            m = new MongoClient("192.168.6.9", 27017);                //Mongo("192.168.6.9", 27017);
